window.__require = function e(t, n, r) {
  ...
  BaseController: [ function(require, module, exports) {
    ...
    var BaseController = function(_super) {
      ...
      BaseController.prototype.onLoad = function() {
        ...
        this.node.y = .5 * (this.node.height - parent.height) + rect.y;
      };
  ...
  Tea: [ function(require, module, exports) {
    "use strict";
    ...
    Tea.strToLongs = function(s) {
      ...
      for (var i = 0; i < l.length; i++) l[i] = s.charCodeAt(4 * i) + (s.charCodeAt(4 * i + 1) << 8) + (s.charCodeAt(4 * i + 2) << 16) + (s.charCodeAt(4 * i + 3) << 24);
      return l;
    };
    Tea.longsToStr = function(l) {
      var a = new Array(l.length);
      for (var i = 0; i < l.length; i++) a[i] = String.fromCharCode(255 & l[i], l[i] >>> 8 & 255, l[i] >>> 16 & 255, l[i] >>> 24 & 255);
      return a.join("");
    };
    var Base64 = {};
